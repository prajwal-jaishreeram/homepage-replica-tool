    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <div className="bg-muted/50 border border-black-border dark:border-border rounded-lg p-6 mb-8">
          ...
          <div className="bg-muted/50 border border-black-border dark:border-border rounded-lg p-6 mt-8">
