...
export function Footer({ className, ...props }: React.ComponentProps<'footer'>) {
	return (
		<footer
			className={cn(
				'border-t border-t-foreground bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)]',
				className,
			)}
			{...props}
		>
			...
			<div className="border-t border-t-foreground">
